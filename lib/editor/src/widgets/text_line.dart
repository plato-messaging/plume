...
class _TextLineState extends State<TextLine> {
  ...
  void didChangeDependencies() {
    ...
    if (_pressedKeys == null) {
      _pressedKeys = PlumePressedKeys.of(context);
  ...
  TextAlign getTextAlign(LineNode node) {
    final alignment = node.style.get(Attribute.alignment);
    if (alignment == Attribute.center) {
      return TextAlign.center;
    } else if (alignment == Attribute.right) {
      return TextAlign.right;
    } else if (alignment == Attribute.justify) {
  ...
  InlineSpan _segmentToTextSpan(Node segment, PlumeThemeData theme) {
    ...
    final isLink = attrs.contains(Attribute.link);
    return TextSpan(
      text: text.value,
