...
List<String> _toggleableStyleKeys = [
  ...
  Attribute.backgroundColor.key,
  Attribute.foregroundColor.key,
];
...
class PlumeController extends ChangeNotifier {
  ...
  Style get toggledStyles => _toggledStyles;
  Style _toggledStyles = Style();
  ...
  // This is required by Plume document model.
  ...
  ///
  /// It creates a new empty [Document] and a clean edit history.
  /// The old [document] will be closed if [closeDocument] is true.
  ///
  /// Calling this will notify all the listeners of this [PlumeController]
...
extension HistoryHandler on PlumeController {
