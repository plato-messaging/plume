...
/// of a [PlumeCheckbox] with a [WidgetStateProperty].
/// In this example, the checkbox's color will be `Colors.blue` when the [PlumeCheckbox]
...
///  * [Switch], a widget with semantics similar to [PlumeCheckbox].
///  * [Radio], for selecting among a set of explicit values.
///  * [Slider], for selecting a value in a range.
///  * <https://material.io/design/components/selection-controls.html#checkboxes>
///  * <https://material.io/design/components/lists.html#types>
class PlumeCheckbox extends StatefulWidget {
  ...
  @override
  State<PlumeCheckbox> createState() => _PlumeCheckboxState();
}

class _PlumeCheckboxState extends State<PlumeCheckbox>
  ...
  @override
  void didUpdateWidget(PlumeCheckbox oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      child: buildToggleable(
        ...
        size: const Size.square(_kEdgeSize),
        painter: _painter
          ..position = position
          ..reaction = reaction
