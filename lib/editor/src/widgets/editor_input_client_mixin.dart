...
mixin RawEditorStateTextInputClientMixin on EditorState
  ...
  void updateRemoteValueIfNeeded() {
    ...
    // PlumeController we need to add it here manually before comparing
  ...
  void updateEditingValueWithDeltas(List<TextEditingDelta> textEditingDeltas) {
    ...
    for (final textEditingDelta in textEditingDeltas) {
      ...
      _lastKnownRemoteTextEditingValue = textEditingDelta.apply(
        _lastKnownRemoteTextEditingValue!,
      );
  ...
  TextInputConnectionStyle getTextStyle([TextPosition? position]) {
    ...
    if (parchmentStyle.contains(Attribute.heading)) {
      final attribute = parchmentStyle.get(Attribute.heading);
