...
class PlumeSpellCheckSuggestionsToolbar extends StatelessWidget {
  /// Constructs a [PlumeSpellCheckSuggestionsToolbar] with the default children for
  /// an [EditorState].
  ///
  ...
  ///  * [PlumeCupertinoSpellCheckSuggestionsToolbar.buttonItems], the list of
...
///
/// See also:
///  * [PlumeSpellCheckSuggestionsToolbar], which is similar but for both the
///    Material and Cupertino libraries.
class PlumeCupertinoSpellCheckSuggestionsToolbar extends StatelessWidget {
  /// Constructs a [PlumeCupertinoSpellCheckSuggestionsToolbar] with the default
  ...
  ///    [ContextMenuButtonItem]s that are used to build the buttons of the
  ///    text selection toolbar.
  ///  * [PlumeSpellCheckSuggestionsToolbar.buttonItems], the list of
