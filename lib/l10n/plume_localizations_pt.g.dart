...
class PlumeLocalizationsPt extends PlumeLocalizations {
  PlumeLocalizationsPt([String locale = 'pt']) : super(locale);
...
class PlumeLocalizationsPtBr extends PlumeLocalizationsPt {
  PlumeLocalizationsPtBr() : super('pt_BR');
