...
abstract base class LeafNode extends Node with StyledNode {
  ...
  void formatAndOptimize(Style? style) {
...
/// A span of formatted text within a line in a [Document].
///
...
final class TextNode extends LeafNode {
  TextNode([String super.text = '']) : assert(!text.contains('\n')), super._();
...
/// An embed node inside of a line in a [Document].
///
