...
abstract class RenderAbstractEditor implements TextLayoutMetrics {
  ...
  /// Starts a [PlumeVerticalCaretMovementRun] at the given location in the text, for
  /// handling consecutive vertical caret movements.
  ///
  /// This can be used to handle consecutive upward/downward arrow key movements
  /// in an editor.
  PlumeVerticalCaretMovementRun startVerticalCaretMovement(
    TextPosition startPosition,
  );
}

/// Displays a Plume document as a vertical list of document segments (lines
/// and blocks).
///
...
class RenderEditor extends RenderEditableContainerBox
  ...
  List<TextSelectionPoint> getEndpointsForSelection(TextSelection selection) {
    ...
    if (selection.isCollapsed) {
      ...
      final localPosition = TextPosition(
        offset: selection.extentOffset - child.node.offset,
      );
  ...
  void performLayout() {
    ...
    while (child != null) {
      ...
      childParentData.offset = Offset(
        resolvedPadding!.left + leftOffset,
        contentHeight,
      );
    ...
    size = constraints.constrain(
      Size(_maxContentWidth ?? contentWidth, contentHeight),
    );
  ...
  Rect getLocalRectForCaret(TextPosition position) {
    ...
    return childLocalRect.shift(
      Offset(resolvedPadding!.left, boxParentData.offset.dy + paintOffset.dy),
    );
  }
  ...
  PlumeVerticalCaretMovementRun startVerticalCaretMovement(
    ...
    return PlumeVerticalCaretMovementRun._(this, startPosition);
  }
...
class PlumeVerticalCaretMovementRun implements Iterator<TextPosition> {
  PlumeVerticalCaretMovementRun._(this._editor, this._currentTextPosition);
  ...
  @override
  bool moveNext() {
    final newCurrentTextPosition = _editor.getTextPositionBelow(
  ...
  bool movePrevious() {
    final newCurrentTextPosition = _editor.getTextPositionAbove(
      _currentTextPosition,
    );
    if (newCurrentTextPosition == _currentTextPosition) return false;
    _currentTextPosition = newCurrentTextPosition;
