...
class EditableTextBlock extends StatelessWidget {
  ...
  List<Widget>? _buildLeading(PlumeThemeData theme, List<LineNode> children) {
    ...
    } else if (block == Attribute.block.bulletList) {
    ...
    } else if (block == Attribute.block.checkList) {
  ...
  VerticalSpacing _getSpacingForLine(
    ...
    if (heading == Attribute.heading.level1) {
      ...
      final block = this.node.style.get(Attribute.block);
      VerticalSpacing? lineSpacing;
      if (block == Attribute.block.quote) {
        lineSpacing = theme.quote.lineSpacing;
      } else if (block == Attribute.block.numberList ||
          block == Attribute.block.bulletList ||
          block == Attribute.block.checkList) {
  ...
  BoxDecoration? _getDecorationForBlock(BlockNode node, PlumeThemeData theme) {
    ...
    } else if (style == Attribute.block.code) {
