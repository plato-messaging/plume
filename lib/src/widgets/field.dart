...
class PlumeField extends StatefulWidget {
  ...
  @override
  State<PlumeField> createState() => _PlumeFieldState();
}

class _PlumeFieldState extends State<PlumeField> {
  late bool _focused;
  ...
  @override
  void didUpdateWidget(covariant PlumeField oldWidget) {
