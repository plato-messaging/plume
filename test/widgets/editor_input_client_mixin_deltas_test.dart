...
import 'package:plume/src/widgets/editor_input_client_mixin.dart';
...
class MockPlumeController extends Mock implements PlumeController {}
...
Matcher matchesMethodCall(String method, {dynamic args}) => _MatchesMethodCall(
  method,
...
class _MatchesMethodCall extends Matcher {
  ...
  Description describe(Description description) {
    final Description newDescription = description
        .add('has method name: ')
...
void main() {
  ...
  group('updateEditingValueWithDeltas', () {
    ...
    test('updated with TextEditingDeltaInsertion', () {
      ...
      when(
        () => initialTextEditingValue.copyWith(
          selection: any(named: 'selection'),
          text: any(named: 'text'),
