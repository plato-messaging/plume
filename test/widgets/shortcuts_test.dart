...
void main() {
  Widget widget(PlumeController controller) {
    return MaterialApp(
      home: Scaffold(
        body: Column(
  ...
  Future<void> testToggle(
    ...
    LogicalKeyboardKey key(Attribute attribute) {
  ...
  Future<void> testIndentation(
    WidgetTester tester, {
    required bool addIndentation,
  }) async {
    final delta = Delta();
    if (addIndentation) {
      delta.insert('test\n');
