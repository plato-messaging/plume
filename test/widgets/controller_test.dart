...
import 'package:plume/util.dart';

void main() {
  group('$PlumeController', () {
    late PlumeController controller;

    setUp(() {
      final doc = Document();
      controller = PlumeController(document: doc);
    });
    ...
    test('formatText', () {
      ...
      expect(
        ...
        Delta()
          ..insert('Words', Attribute.bold.toJson())
          ..insert('\n'),
      );
      // expect(controller.lastChangeSource, ChangeSource.local);
    });
    ...
    test('formatText with toggled style enabled', () {
      ...
      controller.formatText(3, 0, Attribute.bold);
      ...
      expect(
        ...
        Delta()
          ..insert('Won')
          ..insert('B', Attribute.bold.toJson())
          ..insert('rds')
          ..insert('\n'),
      );
      // expect(controller.lastChangeSource, ChangeSource.local);
    ...
    test('Toggleable styles', () {
      ...
      controller.formatText(0, 0, Attribute.italic);
      controller.formatText(0, 0, Attribute.underline);
    ...
    test('replaceText only applies toggled styles to non new line parts', () {
      ...
      expect(
        ...
        Delta()
          ..insert('Wo\n')
          ..insert('Test', Attribute.bold.toJson())
          ..insert('\n')
          ..insert('rds')
          ..insert('\n'),
      );
    ...
    test('insert text with toggled style unset', () {
      ...
      controller.replaceText(0, 0, 'Words');
      controller.formatText(1, 0, Attribute.bold);
      controller.replaceText(1, 0, 'B');
      controller.formatText(2, 0, Attribute.bold.unset);
    ...
    test('getSelectionStyle', () {
      ...
      expect(result.values, [Attribute.bold]);
    });
    ...
    test('getSelectionStyle at start of formatted line', () {
      ...
      controller.formatText(7, 0, Attribute.heading.level1);
      controller.replaceText(7, 0, '\n');
      controller.formatText(8, 0, Attribute.heading.unset);
    ...
    test('getSelectionStyle at start of a new line', () {
      ...
      controller.formatText(0, 7, Attribute.bold);
      controller.replaceText(7, 0, '\n');
