...
void main() {
  ...
  group('$PreserveLineFormatOnNewLineRule', () {
    ...
    test('applies when line-break is inserted at the end of line', () {
      ...
      final expected = Delta()
        ..retain(11)
        ..insert('\n', Attribute.h1.toJson())
        ..retain(1, Attribute.heading.unset.toJson());
      expect(actual, expected);
    });
    ...
    test('applies and keeps block style', () {
      final style = Attribute.ul.toJson();
      style.addAll(Attribute.h1.toJson());
      final doc = Delta()
        ..insert('Hello world')
        ..insert('\n', style);
      final actual = rule.apply(doc, 11, '\n');
  ...
  group('$PreserveInlineStylesRule', () {
    ...
    test('apply preserve link formatting within link', () {
      final doc = Delta()
        ...
        ..insert('http://plume-editor.github.io', {
          'a': 'http://plume-editor.github.io',
        })
        ..insert(' link');
      final actual = rule.apply(doc, 17, 's');
      final expected = Delta()
        ..retain(17)
        ..insert('s', {'a': 'http://plume-editor.github.io'});
      expect(expected, actual);
    });
  ...
  group('$PreserveBlockStyleOnInsertRule', () {
    ...
    test('preserves heading style of the original line', () {
      final quote = Attribute.block.quote.toJson();
      final h1Unset = Attribute.heading.unset.toJson();
      final quoteH1 = Attribute.block.quote.toJson();
      quoteH1.addAll(Attribute.heading.level1.toJson());
      final doc = Delta()
        ..insert('One and two')
        ..insert('\n', quoteH1)
        ..insert('Three')
    ...
    test('preserves checked style of the original line', () {
      ...
      final checkedUnset = Attribute.checked.unset.toJson();
      final clChecked = Attribute.cl.toJson();
      clChecked.addAll(Attribute.checked.toJson());
      final doc = Delta()
        ..insert('One and two')
        ..insert('\n', clChecked)
        ..insert('Three')
