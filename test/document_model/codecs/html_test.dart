  ...
  group('Encode', () {
    ...
    group('Blocks', () {
      ...
      test('Ordered list', () {
        ...
        expect(
          codec.encode(doc),
          '<ol><li>Hello World!</li><li>This is Plume!</li></ol>',
        );
      });
      ...
      test('List with bold', () {
        ...
        expect(
          codec.encode(doc),
          '<ol><li><strong>Hello World!</strong></li><li>This is Plume!</li></ol>',
        );
      });
      ...
      test('Unordered list', () {
        ...
        expect(
          codec.encode(doc),
          '<ul><li>Hello World!</li><li>This is Plume!</li></ul>',
        );
      });
    ...
    test('Multiple styles', () {
      final act = codec.encode(Document.fromDelta(delta));
      expect(act, htmlDoc);
    });
  });
  ...
  group('Decode', () {
    ...
    group('Blocks', () {
      group('Paragraph', () {
        ...
        test('with indentation', () {
          ...
          final doc = HtmlCodec().decode(html);
          expect(
            doc.toDelta(),
            Delta()
              ..insert('Hello World!')
    ...
    group('Embeds', () {
      test('Block embeds special treatment', () {
        String html =
            '<p><hr><p><img src="http://fake.link/image.png"></p>'
...
final doc = [
  ...
  {'insert': 'Plume’s rich text editor is built with '},
  {
...
final htmlDoc =
    ...
    '<p>Plume is an <strong><span style="color: rgba(255,0,0,1.0)">early preview</span></strong> open source library.</p>'
    '<h3>Documentation</h3>'
    '<ul>'
    '<li>Quick Start</li>'
    ...
    '<p>Plume’s rich text editor is built with <em>simplicity and flexibility</em> in mind. It provides clean interface for distraction-free editing. Think <code>Medium.com</code>-like experience.</p>'
